...
st.markdown(
    ...
    .welcome-card {
        ...
        color: #222222;
        font-size: clamp(1.03rem, 3.7vw, 1.38rem);
        line-height: 1.75;
    }
    ...
    st.markdown(
        ...
        <section class="welcome-shell">
            ...
            <div class="welcome-card">
                Tôi là trợ lý hỗ trợ công việc của Chi cục<br>
                Thủy lợi tỉnh Quảng Ngãi.
            </div>
            <div class="welcome-card welcome-card-large">
                Anh/chị có thể yêu cầu tôi tham mưu về<br>
                thủy lợi, cấp nước sạch nông thôn, đê điều,<br>
                phòng, chống thiên tai, tài nguyên nước, khí<br>
                tượng thủy văn; quản lý chất lượng, thi công<br>
                xây dựng và bảo trì công trình xây dựng<br>
                chuyên ngành trên địa bàn tỉnh Quảng Ngãi.
            </div>
